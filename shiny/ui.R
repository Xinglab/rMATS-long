...
ui <- fluidPage(
  ...
  bslib::navset_tab(
    bslib::nav_panel(
      ...
      shiny::textInput('group_1', 'group_1.txt', value='', width='100%'),
      shiny::textInput('group_2', 'group_2.txt', value='', width='100%'),
      ...
      shiny::textInput('summary_plot', 'summary_plot.png', value='',
                       width='100%'),
      shiny::textInput('summary_txt', 'summary.txt', value='', width='100%'),
      shiny::textInput('align_dir', 'alignments-dir', value='', width='100%'),
      shiny::textInput('event_dir', 'events-dir', value='', width='100%'),
      shiny::textInput('count_tsv', 'count.tsv', value='', width='100%'),
      shiny::textInput('combined_gtf', 'combined.gtf', value='', width='100%'),
      shiny::textInput('sample_total_tsv', 'sample_read_totals.tsv',
                       value='', width='100%'),
      shiny::textInput('gencode_gtf', 'gencode.gtf', value='', width='100%'),
      shiny::tags$br(),
      ...
      shiny::textInput('modified_diff_isos',
                       ...
                       width='100%'),
      shiny::textInput('asm_gtf', 'asm.gtf', value='', width='100%'),
      shiny::tags$br(),
      shiny::tags$p('Only if rmats_long.py was run with --abundance will abundance.esp and updated.gtf be needed'),
      shiny::textInput('abundance', 'abundance.esp', value='', width='100%'),
      shiny::textInput('updated_gtf', 'updated.gtf', value='', width='100%'),
      value='data_tab'
    ),
    bslib::nav_panel(
      ...
      bslib::navset_tab(
       ...
       bslib::nav_panel(
         ...
         shiny::selectInput('asm_search_col', 'search-column', base::c(''),
                            selectize=FALSE),
         shiny::textInput('asm_search_key', 'search', value=''),
       ...
       bslib::nav_panel(
         ...
         shiny::selectInput('iso_search_col', 'search-column', base::c(''),
                            selectize=FALSE),
         shiny::textInput('iso_search_key', 'search', value=''),
    ...
    bslib::nav_panel(
      ...
      shiny::tags$br(),
      shiny::tags$p('Set the asm-id and then click find-gene-id-for-asm.'),
      ...
      shiny::actionButton('find_asm_id_for_gene_id', 'find-asm-id-for-gene-id'),
      shiny::actionButton('find_ids_for_gene_name', 'find-ids-for-gene-name'),
      shiny::tags$br(),
      shiny::tags$br(),
      shiny::tags$p('When an abundance plot is created, colors.tsv will also be created'),
      shiny::textInput('isoform_colors', 'colors.tsv', value='', width='100%'),
      shiny::actionButton('check_for_existing_plots', 'check-for-existing-plots'),
      shiny::tags$br(),
      shiny::tags$br(),
      bslib::navset_tab(
       bslib::nav_panel(
