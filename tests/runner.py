...
import tests.all_sjs_filter.test as all_sjs_filter_test
...
import tests.covars.test as covars_test
...
import tests.novel_junctions.test as novel_junctions_test
...
def build_test_suite():
    ...
    suite.addTest(loader.loadTestsFromModule(all_sjs_filter_test))
    ...
    suite.addTest(loader.loadTestsFromModule(covars_test))
    ...
    suite.addTest(loader.loadTestsFromModule(novel_junctions_test))
